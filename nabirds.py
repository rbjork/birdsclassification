...
if __name__ == '__main__':
  ...
  pdb.set_trace()
  part_ids = sorted(part_ids)  # part_ids.sort() # python 2.7
  ...
  #pdb.set_trace()
  image_identifiers = list(image_paths.keys())  # for python 3 added list()
  ...
  for image_id in image_identifiers:
    ...
    # for part_id in part_ids: # python 2.7
    #   x, y, v = parts[part_id]   # problem in python 3.7
    #   print( "%-10s\t%-1s" % (part_names[part_id], 'Y' if v else 'N'))
    #
